...
JSON_FOLDER = "C:/Users/tmarl/Documents/Escuela/Escom/6to/ai/proyecto/scrapping/productos"

# Función para validar los datos
def validate_data(data):
    required_keys = ["titulo", "precio", "rating", "link", "categoria", "imagen"]
...
def transform_data(data):
    return {
        "name": truncate(data["titulo"], 400),  # Truncar a 400 caracteres
        "price": clean_price(data["precio"]),
        "rating": float(data["rating"].split(' ')[0]),  # Tomar solo el primer número
        "image": truncate(data["imagen"], 400),  # Truncar a 400 caracteres
        "category": truncate(data["categoria"], 100),  # Truncar a 100 caracteres
